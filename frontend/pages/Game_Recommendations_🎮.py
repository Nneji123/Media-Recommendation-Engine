...
try:
    ...
    # app design
    app_meta('🖼️')
    set_bg_hack('./images/games.png')

    # hide warning for st.pyplot() deprecation
    st.set_option('deprecation.showPyplotGlobalUse', False)

    # Main panel setup
    display_app_header(main_txt='Games Recommendation App',
                       sub_txt='Get suggestions on what to play next using this recommendations web app!')
...
input_query = st.text_input("Input the Games you last played: ")
values = {"Games": input_query}
...
st.write("These are the Games you should play next:")
resp = st.dataframe(resp)


#st.write(f"These are the Games you should play next: {resp}.")
