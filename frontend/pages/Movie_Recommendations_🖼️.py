...
try:
    ...
    # Main panel setup
    display_app_header(main_txt='Movie Recommendation App',
...
res = re.post(
    f"http://backend.docker:8000/movie", json=values)
json_str = json.dumps(res.json())
resp = json.loads(json_str)

st.write(f"""### These are the movies you should watch next: {resp[0]}.""")
