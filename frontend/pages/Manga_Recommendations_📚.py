...
st.title("Manga Recommendations Web App")
...
input_query = st.text_input("Input the manga you last read: ")
...
st.write(f"""### These are the Manga you should read next: {resp[0]}.""")
